...
public class Lista{
    ...
    public Nodo crearNodo(Empleado x, Nodo p) {
        Nodo q = new Nodo(x,p);
        return q;
    }

    public void insertarPrimero(Empleado x){
        Nodo q = crearNodo(x, primero);
        primero = q;
        cantidad++;
    }
    
    public void insertarUltimo(Empleado x) {
        if (vacia())
            insertarPrimero(x);
        else
        {
    ...
    public void insertarPosicion(Empleado x,int pos) {
    ...
    */
    public Empleado getElemento(int pos) {
    ...
    */ 
    ...
    public Empleado buscarCodigo(int codigo) {
        Nodo nodo = primero;
        while(nodo != null){
            if(nodo.getElem().getCodigo() == codigo){
                return nodo.getElem();
            }
            nodo = nodo.getProx();
        }
